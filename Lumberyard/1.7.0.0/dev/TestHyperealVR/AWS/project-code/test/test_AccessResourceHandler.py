...
class TestAccess(unittest.TestCase):
    ...
    def _do_handler_with_resource_group_stack_test(self, request_type, with_access_stack = True):
        ...
        def mock_list_stack_resources_side_effect(PhysicalResourceId=None, StackName=None):
                    ...
                    'Stacks': [
                        {
                            'Parameters': [
                                {
                                    'ParameterKey': 'DeploymentStackArn',
                                    'ParameterValue': 'TestDeploymentStackId'
                                }
                            ]
                        }
                    ]
        ...
        mock_cf_client.list_stack_resources = mock.MagicMock(side_effect=mock_list_stack_resources_side_effect)
    ...
    def test_handler_with_deployment_stack(self):
        ...
        mock_deployment.deployment_access.resources 
